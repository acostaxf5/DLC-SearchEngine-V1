<%@page import="Servicios.IndexadorLocal"%>

<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<%
    String mensajeOK = IndexadorLocal.mensajeOK;
    String tiempoInsumido = IndexadorLocal.tiempoInsumido;
    String contextPath = IndexadorLocal.contextPath;
%>
